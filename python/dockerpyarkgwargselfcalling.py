...
def run_container(image_name, name=None, protocol='tcp', ports=[], volumes=[]):
...
if __name__ == '__main__':
    ...
    run_container(args.image_name, name=args.name, protocol=args.protocol, ports=args.port, volumes=args.volume, **unknown_args_dict)

    run_container(args.image_name, name=args.name, protocol=args.protocol, ports=args.port, volumes=args.volume)
